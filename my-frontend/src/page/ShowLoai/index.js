...
const ShowLoai = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `http://localhost:1337/api/truyens?filters[the_loai]=${idLoai}&pagination[page]=${trang1}&pagination[pageSize]=6&populate=*`
      )
      .then((res) => {
      ...
      return (
        <>
          <li id={i} className="aaa">
            <Link to={'/theloai/'+idLoai+'/'+i}>{i}</Link>
          </li>
        </>
      )
   } 
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="product__pagination">
                ...
                <Link to={'/theloai/'+idLoai+'/'+pagecount}>
